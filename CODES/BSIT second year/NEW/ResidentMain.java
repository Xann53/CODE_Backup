...
public class ResidentMain{
    ...
    public static void main(String [] args){
        ...
        while(continueLoop){
            try{
                do{ 
                    System.out.println("------------MENU------------");// displays main menu
                    ...
                    switch(choice){
                        ...
                        case 2:
                            if(access == true){ 
                                ...
                                if(choice >= 1 && choice <= 4 ){ //ensures that user only enters numbers 1 to 4
                                    m.Sort(First_Name, Last_Name, Gender, Age, ID, choice, container); // calls Sort method
                                }else{
